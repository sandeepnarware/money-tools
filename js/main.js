...
const tools = [
  ...
  { id: 'gold-loan', name: 'Gold Loan Calculator', icon: '💍', desc: 'Calculate EMI and interest for a gold loan.', cat: 'loan' },
  { id: 'currency-converter', name: 'Currency Converter', icon: '💱', desc: 'Convert between Indian Rupee and major world currencies.', cat: 'plan' },
  ...
  { id: 'ppf-vs-fd', name: 'PPF vs FD', icon: '🔄', desc: 'Compare PPF and Fixed Deposit returns over time.', cat: 'save' },
  ...
  { id: 'nps-vs-mutual-fund', name: 'NPS vs Mutual Fund', icon: '🏦', desc: 'Compare NPS and mutual fund investments for retirement.', cat: 'save' },
  ...
  { id: 'rent-vs-buy', name: 'Rent vs Buy', icon: '🏠', desc: 'Compare the financial impact of renting vs buying a home.', cat: 'plan' },
  { id: 'home-loan-vs-renting', name: 'Home Loan vs Renting', icon: '🏡', desc: 'Compare the long-term cost of buying vs renting a home.', cat: 'plan' },
  { id: 'property-registration', name: 'Property Registration Cost', icon: '📋', desc: 'Estimate stamp duty, registration fees, and other property costs.', cat: 'plan' },
  { id: 'rental-yield', name: 'Rental Yield Calculator', icon: '💰', desc: 'Calculate your propertys gross and net rental yield.', cat: 'invest' },
  ...
  { id: 'emergency-fund-planner', name: 'Emergency Fund Planner', icon: '🆘', desc: 'Plan your emergency fund savings goal step by step.', cat: 'save' },
