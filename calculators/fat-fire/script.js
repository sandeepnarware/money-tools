document.addEventListener('DOMContentLoaded', () => {
  const form = document.getElementById('fatFireForm');
  ...
  const chartCanvas = document.getElementById('fatFireChart');
  ...
  function calculate() {
    ...
    const expenses = parseFloat(document.getElementById('desiredExpenses').value);
